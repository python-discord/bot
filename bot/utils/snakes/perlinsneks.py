...
SNAKE_TEXTS = [
    ...
    "netflx and snek",
    "holy snek prey4u",
    "ghowst snek hauntt u",
    "ipekek snek syrop",
    "2 snek 2 furius",
    "the shawsnek redumpton",
    "snekler's list",
    "snekablanca",
    "romeo n snekulet",
    "citizn snek",
    ...
    "snek of musik",
    "west snek story",
    "snek wars eposide XI",
    "2001: a snek odyssuuy",
    "E.T. the snekstra terrastriul",
    "snekkin' inth rain",
    "dr sneklove",
    "snekley kubrik",
    "willium snekspeare",
    ...
    "snekthony hopkuns",
    "hugh snekman",
    "snek but it glow in durk",
    "snek but u cn ride it",
    "snek but slep in ur bed",
    "snek but mad frum plastk",
    "snek but bulong 2 ur frnd",
    "sneks on plene",
    "baby snek",
    "trouser snek",
    "momo snek",
    ...
    "cashiers snek",
    "mega snek!!",
    "one tim i saw snek neked",
    "snek cnt clim trees",
    "snek in muth is jus tongue",
    "juan snek",
    "photosnek",
]
