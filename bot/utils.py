...
class Paginator:
    ...
    """
    def __init__(self, prefix='```', suffix='```', max_size=2000, line_size=10):
        self.prefix = prefix
        self.suffix = suffix
    ...
    def add_line(self, line='', *, empty=False):
        ...
        if self._linecount >= self.line_size:
            self._linecount = 0
            self.close_page()
...
async def paginate(lines: Iterable[str], ctx: Context, embed: Embed,
                   prefix: str = "", suffix: str = "", max_lines: int = 10, max_size: int = 500, empty: bool = True,
    ...
    paginator = Paginator(prefix=prefix, suffix=suffix, max_size=max_size, line_size=max_lines)
    current_page = 0
